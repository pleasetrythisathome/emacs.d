...

;;;### (autoloads nil "mode-compile" "mode-compile.el" (0 0 0 0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "mode-compile" '("guess-compile" "dired-compile" "default-compile" "ruby-" "perl-" "python-" "tcl-" "zsh-" "cc-" "c++-" "csh-" "sh-" "mode-compile-" "mc--" "makefile-compile" "emacs-lisp-" "elisp-compile" "f77-" "ada-" "java-")))
