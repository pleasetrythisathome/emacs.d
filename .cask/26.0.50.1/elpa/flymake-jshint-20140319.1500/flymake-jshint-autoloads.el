...

;;;### (autoloads nil "flymake-jshint" "flymake-jshint.el" (0 0 0
;;;;;;  0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "flymake-jshint" '("flymake-jshint-" "jshint-configuration-path")))
