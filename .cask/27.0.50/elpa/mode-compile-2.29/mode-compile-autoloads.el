...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "mode-compile" '("ada-" "c++-" "cc-" "csh-" "default-compile" "dired-compile" "elisp-compile" "emacs-lisp-" "f77-" "guess-compile" "java-" "makefile-compile" "mc--" "mode-compile-" "perl-" "python-" "ruby-" "sh-" "tcl-" "zsh-")))
